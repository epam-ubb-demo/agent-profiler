      ...
      <div ref={containerRef} style={{ width: '100%', position: 'relative' }}>
        ...
        >
          ...
          {routingAreaSegments.map((seg, si) => {
            ...
            const topPath = smoothPath(topPts);
            const bottomSmoothPath = smoothPath(bottomPts);
            const reversedBottom = reversePathCommands(bottomSmoothPath);
            const areaPath = topPts.length > 0 ? `${topPath}${reversedBottom} Z` : '';
