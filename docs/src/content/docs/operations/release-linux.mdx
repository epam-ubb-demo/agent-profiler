---
title: Release Runbook — Linux
description: Build and verify the Agent Profiler Linux release artefacts (AppImage and .deb).
---
...
| Icon not showing | Ensure `build/icon.png` exists and is ≥ 512×512 |
