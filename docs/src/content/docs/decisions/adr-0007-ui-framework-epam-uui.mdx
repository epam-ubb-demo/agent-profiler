...
The original decision ([ADR-0002](/agent-profiler/decisions/adr-0002-ui-framework-shadcn/)) selected shadcn/ui + Radix UI as the UI component library, citing licence uncertainty with EPAM UUI. This concern was unfounded — EPAM UUI is MIT-licensed and freely usable in any EPAM project. With the licence question resolved, the rationale for choosing shadcn/ui no longer holds.
