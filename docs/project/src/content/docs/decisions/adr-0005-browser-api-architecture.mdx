---
title: "ADR-0005: Browser Shell + HTTP API Architecture"
description: Decision record for the future browser-accessible variant of Agent Profiler using Fastify, tRPC, and SSE streaming.
---
