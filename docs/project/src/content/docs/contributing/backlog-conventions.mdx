...
description: Epic → Feature → Task hierarchy, labels, branch naming, commit conventions, and Definition of Done for Agent Profiler.
---
...
Use the repository label inventory as the source of truth: [github.com/epam-ubb-demo/agent-profiler/labels](https://github.com/epam-ubb-demo/agent-profiler/labels).
...
Use [Conventional Commits](https://www.conventionalcommits.org/) for every commit and PR title. Examples:
