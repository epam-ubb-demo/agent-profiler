    ...
    const entries: AggregationEntry[] = [
      makeEntry({
        ...
        shutdown: {
          ...
          modelMetrics: [
            { model: 'gpt-4.1', inputTokens: 8000, outputTokens: 4000, cacheReadTokens: 1000, cacheWriteTokens: 500, reasoningTokens: 0, requestCount: 2, premiumRequestCost: 0, apiDurationMs: 5000 },
          ],
      ...
      makeEntry({
        ...
        shutdown: {
          ...
          modelMetrics: [
            { model: 'gpt-4.1', inputTokens: 12000, outputTokens: 6000, cacheReadTokens: 3000, cacheWriteTokens: 1500, reasoningTokens: 0, requestCount: 3, premiumRequestCost: 0, apiDurationMs: 8000 },
          ],
          currentTokens: 0, systemTokens: 0, conversationTokens: 0, toolDefinitionsTokens: 0, codeChanges: {}, timestamp: null,
        },
        toolCalls: [
    ...
    const entries: AggregationEntry[] = [
      makeEntry({
        ...
        shutdown: {
          ...
          modelMetrics: [
            { model: 'claude-sonnet-4', inputTokens: 5000, outputTokens: 2000, cacheReadTokens: 100, cacheWriteTokens: 50, reasoningTokens: 0, requestCount: 3, premiumRequestCost: 0, apiDurationMs: 6000 },
            { model: 'gpt-4.1', inputTokens: 3000, outputTokens: 1000, cacheReadTokens: 200, cacheWriteTokens: 100, reasoningTokens: 0, requestCount: 2, premiumRequestCost: 0, apiDurationMs: 4000 },
          ],
          currentTokens: 0, systemTokens: 0, conversationTokens: 0, toolDefinitionsTokens: 0, codeChanges: {}, timestamp: null,
        },
      }),
      makeEntry({
        ...
        shutdown: {
          ...
          modelMetrics: [
            { model: 'claude-sonnet-4', inputTokens: 7000, outputTokens: 3000, cacheReadTokens: 300, cacheWriteTokens: 150, reasoningTokens: 0, requestCount: 2, premiumRequestCost: 0, apiDurationMs: 5000 },
          ],
          currentTokens: 0, systemTokens: 0, conversationTokens: 0, toolDefinitionsTokens: 0, codeChanges: {}, timestamp: null,
        },
      }),
    ...
    const entries: AggregationEntry[] = [
      makeEntry({
        ...
        shutdown: {
          ...
          modelMetrics: [{ model: 'gpt-4.1', inputTokens: 5000, outputTokens: 2000, cacheReadTokens: 0, cacheWriteTokens: 0, reasoningTokens: 0, requestCount: 1, premiumRequestCost: 0, apiDurationMs: 1000 }],
          currentTokens: 0, systemTokens: 0, conversationTokens: 0, toolDefinitionsTokens: 0, codeChanges: {}, timestamp: null,
        },
      }),
      makeEntry({
  ...
  it('totalCost sums correctly when all sessions have known costs', () => {
    const entries: AggregationEntry[] = [
      makeEntry({
        ...
        shutdown: {
          totalPremiumRequests: 1, totalApiDurationMs: 1000,
          modelMetrics: [{ model: 'gpt-4.1', inputTokens: 1_000_000, outputTokens: 0, cacheReadTokens: 0, cacheWriteTokens: 0, reasoningTokens: 0, requestCount: 1, premiumRequestCost: 0, apiDurationMs: 1000 }],
          currentTokens: 0, systemTokens: 0, conversationTokens: 0, toolDefinitionsTokens: 0, codeChanges: {}, timestamp: null,
        },
      }),
      makeEntry({
        ...
        shutdown: {
          totalPremiumRequests: 1, totalApiDurationMs: 1000,
          modelMetrics: [{ model: 'gpt-4.1', inputTokens: 500_000, outputTokens: 500_000, cacheReadTokens: 0, cacheWriteTokens: 0, reasoningTokens: 0, requestCount: 1, premiumRequestCost: 0, apiDurationMs: 1000 }],
          currentTokens: 0, systemTokens: 0, conversationTokens: 0, toolDefinitionsTokens: 0, codeChanges: {}, timestamp: null,
        },
      }),
    ];
